...
const GlobalStyle = createGlobalStyle`
	:root
	{
		...
		--dca-background-color_button-primary-hover: hsl(205.18, 91.39%, 32.85%);
		--dca-background-color_button-destructive: hsl(354.3, 70.5%, 53.5%);
		--dca-background-color_button-destructive-hover: hsl(354.3, 70.5%, 43.5%);
		--dca-background-color_button-secondary: hsl(0deg 0% 79%);
		--dca-background-color_button-secondary-hover: hsl(0deg 0% 69%);
		...
		--dca-border_default: var(--dca-border_default-width) var(--dca-border_default-style) var(--dca-border_default-color);
		--dca-box-shadow_focus: var(--dca-box-shadow_focus-x) var(--dca-box-shadow_focus-y) var(--dca-box-shadow_focus-blur) var(--dca-box-shadow_focus-spread) var(--dca-box-shadow_focus-color);
	}
